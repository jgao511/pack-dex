...
test("mobile production bundle excludes the development scanner route and UI", async () => {
  ...
  assert.doesNotMatch(bundle, /\/mobile-app\/dev\/card-scanner|Development card text|Scanner Test|Scanner Diagnostics|Run Reference Test|mega-charizard-x-ex-013-094|scannerVisual\.worker|ORB\/RANSAC|indexedCards|__PACKDEX_SCANNER_OCR__/);
});
