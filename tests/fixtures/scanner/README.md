...
- `pixel-real/` contains the four untouched 3024×4032 Pixel JPEGs supplied for the real-photo release gate. Its manifest contains expected identities for assertions only; the scanner-test fixture runner gives recognition a neutral `File` name and does not pass that metadata into matching.
