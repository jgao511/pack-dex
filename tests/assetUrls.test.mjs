...
test("catalog card paths resolve through the assets subdomain at its set root", () => {
...
test("set-relative paths use the same set-root base and absolute URLs remain unchanged", () => {
  assert.equal(
